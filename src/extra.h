...
// I am going to use some more methods to help me to visual debug for Depth of Field
std::vector<glm::vec3> take_fp(); // take the focus points
std::vector<glm::vec3> take_lens(); // take the lens
std::vector<glm::vec3> take_image(); // take the image points
std::vector<Ray> take_rays(); // take the rays
